...
export const CUOSHI_BATTLES = [
  ...
  },
  {
    id: "cs3_two_sources",
    title: "錯史之戰Ⅲ：推論過度",
    blurb: "殘卷由一句官員自誇，斷定「全民擁護」——拆解證據問題。",
    difficulty: "進階",
    pageTitle: "某郡上計殘頁",
    lines: [
      { id: "a", text: "郡守上奏：本年勸農有成，境內稱便。" },
      { id: "b", text: "又謂倉廩稍實，盜賊較往年為少。" },
      { id: "c", text: "因此可斷定全國人民都擁護這位郡守。", wrong: true },
      { id: "d", text: "本年所見上計文書，僅此一件。" },
    ],
    fix: {
      prompt: "呢句應該點改？",
      options: [
        "該官員自稱政績獲支持，仍需其他材料驗證，不能逕指全民擁護。",
        "刪去所有史料，當無呢單事。",
        "改成絕對全國反對。",
        "改成用數學證明全民擁護。",
      ],
      answer: 0,
      repaired: "此乃官員自述，是否得民心，仍需民間或其他記載對讀。",
      skill: "source",
      explain: "單一立場、有限材料，不能直接推成「全國如此」。",
    },
  },
  {
    id: "cs4_policy_cost",
